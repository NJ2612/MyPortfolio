    ...
    <footer className="contact-section" id="contact">
      <div className="contact-content">
        ...
        <div className="contact-grid">
          ...
          <a href="https://drive.google.com/file/d/1yK-xCM14DrGAV5rP09TBqHFT8eSKMJ2i/view?usp=drive_link" target="_blank" rel="noopener noreferrer" className="contact-item">
            <div className="icon-box">
